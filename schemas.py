...
SHODAN_HOST = {
    "name": "shodan_host",
    "description": (
        "FREE, full intel on an IP: ports, services, TLS, CVEs.\n\n"
        ...
        "For the whole workflow, load the shodan:recon skill. It covers the "
        "credit-efficient order (count first, facet, then targeted host "
        "lookups) and how to read the data honestly, including staleness "
        "and CVEs inferred from version banners rather than verified."
    ),
    "parameters": {
        "type": "object",
        "properties": {
...
SHODAN_SEARCH = {
    "name": "shodan_search",
    "description": (
        "Costs a query credit per filtered search, unlike count.\n\n"
        "matching hosts.\n\n"
...
SHODAN_COUNT = {
    "name": "shodan_count",
    "description": (
        "FREE totals and facet breakdowns, same syntax as search.\n\n"
        ...
        "Load the shodan:query-syntax skill for the full filter and facet "
        "reference, and shodan:recon for the count-first workflow. Neither "
        "is loaded unless you ask for it by name."
    ),
    "parameters": {
        "type": "object",
        "properties": {
...
SHODAN_DNS = {
    "name": "shodan_dns",
    "description": (
        "Subdomain enumeration costs a credit, resolution is free.\n\n"
...
SHODAN_CVE = {
    "name": "shodan_cve",
    "description": (
        "FREE and keyless, CVE data with CVSS, EPSS and KEV status.\n\n"
...
SHODAN_ACCOUNT = {
    "name": "shodan_account",
    "description": (
        "FREE, reports plan, credits left and session budget.\n\n"
...
SHODAN_META = {
    "name": "shodan_meta",
    "description": (
        "FREE, validates a query before you spend a credit on it.\n\n"
...
SHODAN_SCAN = {
    "name": "shodan_scan",
    "description": (
        "Sends real probes and spends scan credits, off by default.\n\n"
...
SHODAN_ALERT = {
    "name": "shodan_alert",
    "description": (
        "Creates standing monitors that outlive this conversation.\n\n"
        ...
        "anything.\n\n"
        "Load the shodan:monitoring skill before creating anything. It "
        "covers the fourteen triggers, the notifier providers, and the trap "
        "where a freshly created alert has no triggers and therefore never "
        "fires."
    ),
    "parameters": {
        "type": "object",
...
SHODAN_EXPLOITS = {
    ...
    "description": (
        "Finds public exploit code for a CVE you already found.\n\n"
...
SHODAN_QUERY = {
    "name": "shodan_query",
    "description": (
        "FREE, browses search queries other people have refined.\n\n"
...
SHODAN_TRENDS = {
    "name": "shodan_trends",
    "description": (
        "Historical match counts by month, needs an Enterprise plan.\n\n"
